...
namespace ShoutOut.Migrations
{
    ...
    [Migration("20231016130628_AddGiphyGifUrlToPointHistory")]
    partial class AddGiphyGifUrlToPointHistory
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("shout_out_api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Role = 0,
                            UserName = "Admin User",
                            VerifiedAt = new DateTime(2023, 10, 16, 13, 6, 27, 953, DateTimeKind.Utc).AddTicks(8264)
                        });
                });
